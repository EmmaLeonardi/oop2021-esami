...
public class Test {
     ...
     * come estremi (vertici opposti) le due celle clickate assumono un '*' 
     * 3 - si ricomincia col punto 1, finché non succede che tutte le celle hanno un '*', 
     * a quel punto le si disabilitano tutte
     * 
     ...
     * - controllo della logica di completamento del gioco
     *  
